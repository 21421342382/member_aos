...
class ProfileController extends OkitoController with ToastMixin {
  ...
  FormData computeFormData(drop_down_val) {
  ...
  _createProfile() {
    KLoader().show();
    repository.createProfile(data: computeFormData(dropdown_val.dropdownvalue)).then((value) {
      KLoader.hide();
  ...
  _updateProfile() {
    KLoader().show();
    repository.updateProfile(data: computeFormData(dropdown_val.dropdownvalue)).then((value) {
      KLoader.hide();
      Okito.use<AuthService>().profile = value.profile;
